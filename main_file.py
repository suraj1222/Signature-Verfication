...
Original file is located at
    https://colab.research.google.com/drive/1nMIBLAVAPIOllBZhX2c7sOufVCzSZh96
"""
...
img1_message = tk.Label(root, text="Anchor Image", font=10)
...
img2_message = tk.Label(root, text="validation Image", font=10)
